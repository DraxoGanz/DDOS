...
import time
import os
os.system('color ' +random.choice(['B'])+ " & cls & DRAX TOOLS DDOS V1 [ Enter Pass ]")
...
print("=======================================================================================")
print("[ × ]  Visible Comunity [ × ]")
print("[ + ]  Visible Comunity by Drax")
print("[ + ] DONT FORGET SUBSCRIBE DraxWng")
print("=======================================================================================")
print("[ + ] Author: DraxWng")
print("[ + ] Update Tool: Visible Comunity")
print("==========================")
